...
Az alkalmazás indítására két módszer közül választhatunk.
...
\subsection{Alklamazás indítása saját gépről} % Lists with narrow spacing inbetween items
...
\subsection{Információ felületek} % Multi rows and multi columns
